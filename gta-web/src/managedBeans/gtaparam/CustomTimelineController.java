...
/*******************************************************************************/
   ...
   /***********************CHARTS************************************/
	...
	public void chargerCle()
	{
		...
		if(numeroCompte!="" && codeBanque!="" & codePays!="" && codeAgence!="" && cle!="")
		{
			...
			bancaire.setIban(getIBAN(codePays,codeBanque,codeAgence,numeroCompte,cle));
				  ...
				  message = new FacesMessage("Le clé RIB est Incorrect. Mettre RIB = "+verifierRIB(codeBanque,codeAgence,numeroCompte));
	...
	public void showMessage() {
		 FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Message", "L'embauche est enregistré .");
